...
{public:
	...
	virtual int Match2Lists (const char * List1Name, const char * List2Name, const char * OutputListName);
		// 2-way sequential matching algorithm
	virtual int Merge2Lists (const char * List1Name, const char * List2Name, const char * OutputListName);
...
int CosequentialProcess<ItemType>::Match2Lists
	(const char * List1Name, const char * List2Name, const char * OutputListName)
{
	...
	while (MoreItems){
		if (Item(1) < Item(2))//compare a current item for List1 and a current item from List2
