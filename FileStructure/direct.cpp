...
void makeNames(const char * name, char *& dirName, char *& bktName)
{
...
int Directory::Insert(const char * key, int recAddr)
{
...
int Directory::Remove(const char * key)
...
int Directory::Search(const char * key)
...
int Directory::Find(const char * key)
